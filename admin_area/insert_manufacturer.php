...
<i class="fa fa-money fa-fw"> </i> Insert Author
...
<label class="col-md-3 control-label"> Show as Top Author </label>
...
<label class="col-md-3 control-label"> Select Author Image </label>
